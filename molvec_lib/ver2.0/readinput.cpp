...
void readParticleFile_sa_sym_new_tri(const string &filename, double **pos, int &natoms, int *moltype, int *eletype, int *symtype, double *box, int& timeframe, int& timestep, double *boxinfo, int *G_ID)
{
	double posx,posy,posz;
	int tempid, tempmol, tempele, tempsym;
	char dummy_char[256];                //dummy line
	double xlo_bound,ylo_bound,zlo_bound,xhi_bound,yhi_bound,zhi_bound,xy,yz,xz,xlo,xhi,ylo,yhi,zlo,zhi;
        ifstream confFile;
...
void readParticleFile_sa_sym_new(const string &filename, double **pos, int &natoms, int *moltype, int *eletype, int *symtype, double *box, int& timeframe, int& timestep, double *boxinfo, int *G_ID)
{
	double posx,posy,posz;
	int tempid, tempmol, tempele,tempsym;
	char dummy_char[256];                //dummy line
