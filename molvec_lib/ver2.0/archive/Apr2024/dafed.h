...
class CParameter{
	...
	public:
		...
		bool sym_new_flag;		//DK: added for the sym_new style. This takes sym_type as a vector input
};
...
//find the neighbor information in here	
	...
	void get_NN_sym_new(CAtom *,int, int &, NNvariables &);  
	...
	void test_vec(double **,int &, int *, int *, int *, double *,CParameter &,string &,double *,int &, int *);
