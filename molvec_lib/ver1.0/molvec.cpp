...
//stand alone only. short version of one above. 
...
///**/	int nsfg3NN = parameter.nsfg3NN;
	...
	int outi;
	int outNN_index[2];
//	double dgdxI[2*parameter.symftype][3];
//	double dgdxJ[2*parameter.symftype][3];
...
/**/	double CCO,dC, ACO, dA;
	...
	double nmol = parameter.nmol;
	double lmpmol = lmpneigh.lmpmol;
	//cout <<"Beginning of derivative" << endl;
	//cout <<"parameter.nex = " << parameter.nex << endl;
