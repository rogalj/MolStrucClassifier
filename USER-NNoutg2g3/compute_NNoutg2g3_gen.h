...
ComputeStyle(nnoutg2g3gen/atom,ComputeNNoutg2g3gen)

#else

#ifndef LMP_COMPUTE_NNOUTg2g3_gen_H
#define LMP_COMPUTE_NNOUTg2g3_gen_H
#include "compute.h"
#include <fstream>
#include <sstream>
#include "../Dafed.h"
...
class ComputeNNoutg2g3gen : public Compute {
 public:
  ComputeNNoutg2g3gen(class LAMMPS *, int, char **);
  ~ComputeNNoutg2g3gen();
  void init();
...
//  char *rvar;                    // for incremental dumps
  ...
  int nprocs;
  ofstream of_g2g3error;
  ofstream of_g2g3good;
  ofstream of_g2g3output;
  int totalsfg;
  double percent_error = 0.5;
  double *RskappaLst;	
  double *etaLst;
  int *sfgnum;
  double rdiff = 0.2;
