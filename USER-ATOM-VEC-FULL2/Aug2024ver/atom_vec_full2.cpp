...
AtomVecFull2::AtomVecFull2(LAMMPS *lmp) : AtomVec(lmp)
{
  ...
  // clang-format off
  fields_grow = {"q", "molecule", "num_bond", "bond_type", "bond_atom", "sym_type", "num_angle", "angle_type",
  ...
  fields_copy = {"q", "molecule", "num_bond", "bond_type", "bond_atom", "sym_type", "num_angle", "angle_type",
    "angle_atom1", "angle_atom2", "angle_atom3", "num_dihedral", "dihedral_type", "dihedral_atom1",
    "dihedral_atom2", "dihedral_atom3", "dihedral_atom4", "num_improper", "improper_type",
    "improper_atom1", "improper_atom2", "improper_atom3", "improper_atom4", "nspecial", "special"};
  fields_border = {"q", "molecule", "sym_type"};
  fields_border_vel = {"q", "molecule", "sym_type"};
  fields_exchange = {"q", "molecule", "num_bond", "bond_type", "bond_atom", "sym_type",
 ...
 fields_restart = {"q", "molecule", "num_bond", "bond_type", "bond_atom", "sym_type", "num_angle",
  ...
  fields_create = {"q", "molecule", "num_bond", "num_angle",
    "num_dihedral", "num_improper", "nspecial", "sym_type"};
  fields_data_atom = {"id", "molecule", "type", "q", "sym_type", "x"};
...
void AtomVecFull2::grow_pointers()
{
...
void AtomVecFull2::pack_restart_pre(int ilocal)
{
...
void AtomVecFull2::pack_restart_post(int ilocal)
{
...
void AtomVecFull2::unpack_restart_init(int ilocal)
{
  nspecial[ilocal][0] = 0;
  nspecial[ilocal][1] = 0;
  nspecial[ilocal][2] = 0;
...
void AtomVecFull2::data_atom_post(int ilocal)
{
  num_bond[ilocal] = 0;
  num_angle[ilocal] = 0;
