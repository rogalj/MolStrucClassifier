...
#ifdef ATOM_CLASS
// clang-format off
AtomStyle(full2,AtomVecFull2);
// clang-format on
#else

#ifndef LMP_ATOM_VEC_FULL2_H
#define LMP_ATOM_VEC_FULL2_H

#include "atom_vec.h"

namespace LAMMPS_NS {

class AtomVecFull2 : virtual public AtomVec {
 public:
  AtomVecFull2(class LAMMPS *);
  ~AtomVecFull2() override;
