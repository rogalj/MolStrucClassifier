...
AtomVecFull2::AtomVecFull2(LAMMPS *lmp) : AtomVec(lmp)
{
  ...
  fields_grow = (char *)
    "q molecule num_bond bond_type bond_atom sym_type "
  ...
  fields_reverse = (char *) "";
  fields_border = (char *) "q molecule sym_type";
  fields_border_vel = (char *) "q molecule sym_type";
  ...
  fields_restart = (char *)
    ...
    "improper_atom3 improper_atom4";
  fields_create = (char *)
    "q molecule num_bond num_angle num_dihedral num_improper nspecial sym_type ";
  fields_data_atom = (char *) "id molecule type q sym_type x";
